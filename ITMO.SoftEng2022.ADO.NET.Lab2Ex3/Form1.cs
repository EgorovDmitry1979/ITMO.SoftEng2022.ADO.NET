...
// Упражнение 2.3. Выполнение транзакций
...
namespace DBConnection
{
    public partial class Form1 : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                command.CommandText = "INSERT INTO Products (ProductName) VALUES('Wrong size1')";
                command.ExecuteNonQuery();
                command.CommandText = "INSERT INTO Products (ProductName) VALUES('Wrong color1')";
                command.ExecuteNonQuery();
