...
namespace Linq_Student
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Упражнение 7.3. Расширение возможностей запроса
            // п.1. Присвоение переменной неявного типа
            ...
            // п.1-4. Упорядочение групп по значению их ключа
            ...
            // п.6. Введение идентификаторов с помощью let
            ...
            // п.8. Использование синтаксиса метода в выражении запроса
